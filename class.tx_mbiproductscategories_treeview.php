...
/* 					} */
					...
					if($config['treeViewClass'] AND is_object($treeViewObj = &t3lib_div::getUserObj($config['treeViewClass'],'user_',false)))      {
						...
						$treeViewObj = t3lib_div::makeInstance('tx_mbiproductscategories_tceFunc_selectTreeView');
					}
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mbi_products_categories/class.tx_mbiproductscategories_treeview.php'])    {
    include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mbi_products_categories/class.tx_mbiproductscategories_treeview.php']);
}
?>
